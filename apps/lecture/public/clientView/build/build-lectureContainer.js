...
},{"./vue/lecture-container-navigator.vue":4,"./vue/lecture-container-sidemenu.vue":5,"./vue/lecture-container.vue":6,"vue":2}],4:[function(require,module,exports){
;(function(){
//
//
//
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_vm._v("\n  sidemenu here~\n  "),_c('p'),_vm._v("\n  "+_vm._s(_vm.pickedChapter)+" > "+_vm._s(_vm.pickedItemId)+"\n  "),_c('button',{staticClass:"btn btn-secondary",on:{"click":function($event){_vm.testNotifyParent("chapter03", $event)}}},[_vm._v("change to chapter03 > 99")])])}
